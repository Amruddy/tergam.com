    ...
    <div className="relative overflow-hidden border-b border-slate-50 dark:border-white/3 last:border-0">
      ...
      >
        ...
        <div className="text-right flex-shrink-0">
          ...
          <div className="text-xs text-slate-400 dark:text-gray-500">{formatDate(tx.date)}</div>
        </div>
    ...
    <>
      ...
      <div className="md:hidden bg-white dark:bg-[#13131a] border border-slate-200 dark:border-white/[0.06] rounded-2xl overflow-hidden">
        <div className="px-4 py-3 border-b border-slate-100 dark:border-[#1e1e2e] flex items-center justify-between">
          <span className="text-xs text-slate-400 dark:text-gray-500"><span className="text-slate-900 dark:text-white font-medium">{filtered.length}</span> записей</span>
          <span className="text-xs text-slate-400 dark:text-gray-500 italic">← потяните для удаления</span>
        </div>
