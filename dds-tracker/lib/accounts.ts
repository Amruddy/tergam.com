...
export const DEFAULT_ACCOUNTS: Account[] = [
  { id: 'cash', name: 'Наличные', emoji: '💵', color: '#22c55e', type: 'cash', initialBalance: 0, archived: false, createdAt: '2026-04-11T00:00:00.000Z' },
  { id: 'card', name: 'Карта', emoji: '💳', color: '#6366f1', type: 'card', initialBalance: 0, archived: false, createdAt: '2026-04-11T00:00:00.000Z' },
  { id: 'savings', name: 'Сбережения', emoji: '🪙', color: '#f59e0b', type: 'savings', initialBalance: 0, archived: false, createdAt: '2026-04-11T00:00:00.000Z' },
  { id: 'debt', name: 'Долги', emoji: '📉', color: '#ef4444', type: 'debt', initialBalance: 0, archived: false, createdAt: '2026-04-11T00:00:00.000Z' },
]
...
export const getDefaultAccountId = () => DEFAULT_ACCOUNTS[1].id
